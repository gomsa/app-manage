...
* [x] 2019.06.13 修复不显示X轴滚动条时，拖拽时漏出X轴数据标签的问题。
* [x] 2019.06.13 修改饼图数据全部为0时，平均分布图形区块大小。
* [x] 2019.06.13 修复饼图分割线相交时，尖角问题。
* [x] 2019.06.13 增加`opts.series.disableLegend`  `混合图表`中禁止显示ToolTip图例，默认false即默认显示该类别图例 。
* [x] 2019.06.13 修复柱状图，如果是自定义颜色下，数值为0时，微信小程序上方会出现无规律小点点的bug。
...
- [ ] 2019.06.xx 计划加入`条状图`、`分时图`、`玫瑰图`
- [ ] 2019.06.xx 计划加入`渐变颜色填充`功能
- [ ] 2019.06.xx 推迟计划加入`第二种仪表盘样式`,增加[《亲手教您如何改造uCharts，打造您的专属图表》](https://github.com/16cheng/uCharts/wiki/%E4%BA%B2%E6%89%8B%E6%95%99%E6%82%A8%E5%A6%82%E4%BD%95%E6%94%B9%E9%80%A0wx-charts)教程。
- [ ] 2019.06.xx 计划修改X轴刻度标签`抽稀策略`，以适应K线图及不需要文案旋转的需求
- [ ] 2019.06.xx 计划加入`辅助线（标记线）`功能，支持`柱状图、折线图、区域图、K线图`
- [ ] 2019.06.xx 完善K线图及其辅助功能。
- [ ] 2019.06.xx 计划修复折线图样式为曲线时，个别情况下曲线超出x轴的问题。
