    ...
    <view class="container">  
		<view class="user-section">
			...
			<view class="user-info-box">
				...
				<view class="user-box" @click="navTo('/pages/user/info')">
					<text class="gIcon-qr_code_light"></text>
					<text class="cuIcon-right"></text>
				</view>
			</view>
			<view class="vip-card-box">
				<image class="card-bg" src="/static/user/vip-card-bg.png" mode=""></image>
				<view class="b-btn">
					立即开通
				</view>
				<view class="tit">
				...
				<text class="e-m">NewCentury Union</text>
				<text class="e-b">开通会员畅想优惠无限</text>
			</view>
		</view>
		...
		>
			...
			<view class="order-section">
				...
				<view class="order-item" @click="navTo('/pages/order/order?state=1')"  hover-class="common-hover" :hover-stay-time="50">
					<text class="yticon gIcon-redpacket_fill"></text>
					<text>待付款</text>
				</view>
				<view class="order-item" @click="navTo('/pages/order/order?state=2')" hover-class="common-hover"  :hover-stay-time="50">
					<text class="yticon gIcon-presentfill"></text>
					<text>待收货</text>
				</view>
